...
const { signup, login, logout,getProfil,adduser,getusers,getuserById,updateUser, deleteUser,getDeletedUsers, changePassword} = require("../controllers/userController");
...
router.put("/editPassword", isAuthenticated,changePassword)
